...
```{r warning=FALSE, error=FALSE, message=FALSE, dev='png', dpi=600, fig.width = 8, fix.height = 10, bikedensity-plot1}
...
```{r warning=FALSE, error=FALSE, message=FALSE, dev='png', dpi=600, fig.width = 12, fig.height = 8, bikedensity-plot2}
